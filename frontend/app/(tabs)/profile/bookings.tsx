...
export default function BookingsHistoryScreen() {
  ...
  const fetchBookings = async (refresh = false) => {
    ...
    try {
      ...
      const response = await bookingsAPI.getUserBookings(user.id, params);
        ...
        {isLoading ? (
          ...
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySubtitle}>
              {dateRange.startDate ? "Try adjusting your dates" : "You haven't made any bookings yet"}
            </Text>
          </View>
        ) : (
            ...
            >
              ...
              <View style={styles.cardContent}>
                <View style={styles.infoRow}>
                  ...
                  <Text style={styles.infoText}>{booking.property?.address || "Unknown location"}</Text>
                </View>
